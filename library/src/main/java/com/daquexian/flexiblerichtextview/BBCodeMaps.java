...
public class BBCodeMaps {
    ...
    public static Map<String, String> getHTMLMap() {
        ...
        htmlMap.put("<blockquote>(.+?)</blockquote>", "\\[blockquote\\]$1\\[/blockquote\\]");
        ...
        htmlMap.put("<span style=\"font-size:(.+?);\">(.+?)</span>", "\\[size=$1\\]$2\\[/size\\]");
        htmlMap.put("<font color=\"(.+?);\">(.+?)</font>", "\\[color=$1\\]$2\\[/color\\]");
        htmlMap.put("<font color='(.+?);'>(.+?)</font>", "\\[color=$1\\]$2\\[/color\\]");
        htmlMap.put("<font face=\"(.+?);\">(.+?)</font>", "$2");
        htmlMap.put("<font face='(.+?);'>(.+?)</font>", "$2]");
        htmlMap.put("<font face='(.+?);' color=\"(.+?);\">(.+?)</font>", "\\[color=$2\\]$3\\[/color\\]");
        htmlMap.put("<font face='(.+?);' color='(.+?);'>(.+?)</font>", "\\[color=$2\\]$3\\[/color\\]");
        htmlMap.put("<font color=\"(.+?);\" face=\"(.+?)\">(.+?)</font>", "\\[color=$1\\]$3\\[/color\\]");
        htmlMap.put("<font color='(.+?);' face='(.+?);'>(.+?)</font>", "\\[color=$1\\]$3\\[/color\\]");
    ...
    public static Map<String, String> getBBcodeMap() {
        ...
        bbMap.put("\\[blockquote\\](.+?)\\[/blockquote\\]", "<blockquote>$1</blockquote>");
        bbMap.put("\\[quote=(.+?)\\](.+?)\\[/quote\\]", "<blockquote>$2</blockquote>");
        bbMap.put("\\[blockquote=(.+?)\\](.+?)\\[/blockquote\\]", "<blockquote>$2</blockquote>");
        bbMap.put("\\[p\\](.+?)\\[/p\\]", "<p>$1</p>");
